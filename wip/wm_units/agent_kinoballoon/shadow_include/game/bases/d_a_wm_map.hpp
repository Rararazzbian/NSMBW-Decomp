...
public:
    ...
    /// @unofficial Proposed this round. `GetChildNodeID__9daWmMap_cFPCci`, called from
    /// daWmKinoBalloon_c (fn_2_16A7C0) as `GetChildNodeID(pointName, 0)`.
    int GetChildNodeID(const char *pointName, int index);
