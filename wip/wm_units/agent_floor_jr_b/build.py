...
SRC = os.path.join(HERE, 'd_a_floor_jr_b.cpp')
...
objs = [
    'bin/dtkspl/d_basesNP/obj/auto_00_0008405C_text.o',
]
cmd = 'python wip/wm_units/verify_anon.py {} 0x841e0 0x84290 {}'.format(TXT, ' '.join(objs))
os.system(cmd)
