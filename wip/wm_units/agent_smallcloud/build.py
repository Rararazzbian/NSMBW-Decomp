"""Compile + verify wip/wm_units/agent_smallcloud/d_a_wm_smallcloud.cpp, per the
brief: module='d_basesNP' (REL flags differ from DOL flags), both include dirs
required (shadow_include supplies the GetNodePos(const char*, mVec3_c&) overload).
"""
import os
import sys
