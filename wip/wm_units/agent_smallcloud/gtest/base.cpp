...
// [Required to reproduce the .rodata pool's leading two words, which no
//  placed function in this TU references -- see the source-level analysis in
//  this task's report. It will be deadstripped by the linker later.]
DECL_WEAK
void DUMMY_ORDERING_SC() {
    static const u32 UNUSED[] = { 0x80000, 0x80000 };
}
