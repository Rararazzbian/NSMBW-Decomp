...
static const s16 *GetBgmValueW5() {
    return sGlobalData_c<daWmSmallCloud_c>::mData.mBgmValueW5;
}
...
int daWmSmallCloud_c::create() {
    ...
    if (dScWMap_c::m_WorldNo == 5) {
        const s16 *bgmValueW5 = GetBgmValueW5();
        bgmSync->m_18 = bgmValueW5;
        bgmSync->m_04 = bgmValueW5[0] - 1;
        bgmSync->m_08 = bgmValueW5[1];
    } else {
