...
SRC = os.path.join(HERE, 'd_a_wm_hanachan.cpp')
...
objs = [
    'bin/dtkspl/d_basesNP/obj/auto_00_00164404_text.o',
    'bin/dtkspl/d_basesNP/obj/auto_fn_2_165B20_text.o',
    'bin/dtkspl/d_basesNP/obj/auto_00_00165C48_text.o',
]
cmd = 'python wip/wm_units/verify_anon.py {} 0x164430 0x165c70 {}'.format(TXT, ' '.join(objs))
os.system(cmd)
