...
SRC = os.path.join(HERE, 'd_a_dummy_door.cpp')
...
objs = [
    'bin/dtkspl/d_basesNP/obj/auto_00_000774BC_text.o',
]
cmd = 'python wip/wm_units/verify_anon.py {} 0x77af0 0x77c50 {}'.format(TXT, ' '.join(objs))
os.system(cmd)
