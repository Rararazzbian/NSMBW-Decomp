...
// EXPERIMENT: inline (weak), defined OUTSIDE the class body (so it is NOT
// subject to delayed member-function-body parsing), pragma wraps only the
// static declaration itself.
inline const char *daWmKinokoBase_c::getModelName() {
#pragma explicit_zero_data on
    static char smc_emptyModelName_inline[8] = "";
#pragma explicit_zero_data off
    return smc_emptyModelName_inline;
}
...
/// EXPERIMENT: getModelName moved inline into the class body above.
