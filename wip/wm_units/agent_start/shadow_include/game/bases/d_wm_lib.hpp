...
namespace dWmLib {
    ...
    /// today. Same shape as isStartPointKinokoHouseStar/Red; the target calls it right after
    /// those two fail, gating a `construct__10dWmActor_cFUsP7dBase_cUlPC7mVec3_cPC7mAng3_c`
    /// call with profile ID 0x27c (a third kinoko-house child-actor variant).
