...
/// @unofficial The base has no model of its own; derived classes override this.
/// The target returns an 8-byte zero object at the very end of .data (unit
/// offset 0x1b8), not a pooled "" literal.
