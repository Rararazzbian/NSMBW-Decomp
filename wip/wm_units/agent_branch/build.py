...
SRC = os.path.join(HERE, 'd_a_branch.cpp')
...
objs = [
    'bin/dtkspl/d_basesNP/obj/auto_00_00067344_text.o',
]
cmd = 'python wip/wm_units/verify_anon.py {} 0x676f0 0x677b0 {}'.format(TXT, ' '.join(objs))
os.system(cmd)
