...
SRC = os.path.join(HERE, 'd_a_wm_anchor.cpp')
...
objs = [
    'bin/dtkspl/d_basesNP/obj/auto_00_0015A4AC_text.o',
    'bin/dtkspl/d_basesNP/obj/auto_fn_2_15ABD0_text.o',
    'bin/dtkspl/d_basesNP/obj/auto_00_0015AC54_text.o',
]
cmd = 'python wip/wm_units/verify_anon.py {} 0x15a5a0 0x15ac80 {}'.format(TXT, ' '.join(objs))
os.system(cmd)
