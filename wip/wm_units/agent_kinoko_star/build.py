...
SRC = os.path.join(HERE, 'd_a_wm_kinoko_star.cpp')
...
objs = [
    'bin/dtkspl/d_basesNP/obj/auto_00_0016BF44_text.o',
    'bin/dtkspl/d_basesNP/obj/auto_fn_2_16C0A0_text.o',
    'bin/dtkspl/d_basesNP/obj/auto_00_0016C124_text.o',
]
cmd = 'python wip/wm_units/verify_anon.py {} 0x16bf70 0x16c150 {}'.format(TXT, ' '.join(objs))
os.system(cmd)
