...
SRC = os.path.join(HERE, 'd_a_ac_switch.cpp')
...
objs = [
    'bin/dtkspl/d_basesNP/obj/auto_00_0007D050_text.o',
]
cmd = 'python wip/wm_units/verify_anon.py {} 0x7d400 0x7d630 {}'.format(TXT, ' '.join(objs))
os.system(cmd)
