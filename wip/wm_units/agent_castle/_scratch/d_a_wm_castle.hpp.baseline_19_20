...
public:
    ...
    /// public API, called from an undecompiled sibling unit. Not verified byte-exact end to end
    /// (the object it reads from is itself an experimental hypothesis, see this task's report).
    mVec3_c getKoopaShipStopPos() const;
