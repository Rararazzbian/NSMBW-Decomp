...
void dLineMng_c::initializeState_Circle() {
    circle_nextpos_set(mVec2_c(8.0f, 1303.79833984375f), 8.0f);
}
...
void dLineMng_c::initializeState_Circle2x2LeftDown() {
    circle_nextpos_set(mVec2_c(-16.0f, 651.899169921875f), -16.0f);
}
...
void dLineMng_c::initializeState_Circle4x4LeftDown() {
    circle_nextpos_set(mVec2_c(-32.0f, 325.9495849609375f), -32.0f);
}
