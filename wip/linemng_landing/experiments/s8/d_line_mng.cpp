...
#define UNIT_X (*(const volatile f32 *)&dLineMng_c::smc_UNIT_SIZE_X)
...
void dLineMng_c::init(const mVec2_c &pos, f32 speed, int lineType, u8 param)
{
    ...
    mBaseSpeed = speed;
    f32 unit = UNIT_X;
    mUnitBasePos.x = (f32)(int)(pos.x / unit) * unit;
    mUnitBasePos.y = (f32)(int)(pos.y / unit) * unit;
    mAngle = 0;
    mType = param;
    mReverse = 0;
...
void dLineMng_c::start_line_move()
{
    ...
    if (t > -0.1f && t < 0.1f) {
        ...
        f32 unit = UNIT_X;
        f32 px = mPos.x;
        snap.x = (f32)(int)(px / unit) * unit - 16.0f;
        f32 py = mPos.y;
        snap.y = (f32)(int)(py / unit) * unit;
...
bool dLineMng_c::check_term()
{
    ...
    do {
        ...
        f32 sy = by + p->y;
        mVec2_c testPos;
        testPos.x = (f32)(int)(sx / unit) * unit;
        testPos.y = (f32)(int)(sy / unit) * unit;
...
static void fn_800C31C0(dLineMng_c *self)
{
    ...
    f32 unit = UNIT_X;
    f32 bx = mp.x;
    base.x = (f32)(int)(bx / unit) * unit - 16.0f;
    f32 by = mp.y;
    base.y = (f32)(int)(by / unit) * unit - 16.0f;
