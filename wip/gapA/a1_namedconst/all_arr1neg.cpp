...
static const f32 kCos27[1] = { 0.8910065f };
static const f32 kNegCos27[1] = { -0.8910065f };
...
void dLineMng_c::executeState_Right60Down() {
    mVec2_c old = mPos;
    mSpeed.y = mBaseSpeed * kNegCos27[0];
    mSpeed.x = -(0.5f * mSpeed.y);
    mPos.y += mSpeed.y;
    f32 t = mUnitBasePos.x + 8.0;
    mPos.x = t + 0.5 * (mUnitBasePos.y - mPos.y);
