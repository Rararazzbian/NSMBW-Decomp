...
public:
    ...
    bool is_unit_circle2x2(ulong unitID); ///< Confirmed bool: `li r3, 0x1/0x0; blr`.
    bool is_unit_circle4x4(ulong unitID); ///< Confirmed bool: `li r3, 0x1/0x0; blr`.
    void change_dir(); ///< Negates mBaseSpeed and flips mReverse.
    void getLineUnitNo(f32, f32); ///< @unofficial Return type NOT YET PROVEN (calls dBc_c::getUnitType/getUnitKind). Declared void as a placeholder.
    ...
    void mov_to_rightupper(ulong, const mVec2_c &, bool);
    void mov_to_rightlower(ulong, const mVec2_c &, bool);
    void mov_to_leftupper(ulong, const mVec2_c &, bool);
    void mov_to_leftlower(ulong, const mVec2_c &, bool);
