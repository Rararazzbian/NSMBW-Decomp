// Research probe only -- NOT a deliverable. Tests whether the destructor's
// missing redundant guard depends on how big/complex the surrounding TU is
// (an -ipa file / whole-function-list effect), by combining nearly every
// other batch's already-written function bodies into one file and re-
// checking __dt__13dNandThread_cFv's shape. Bodies are copied verbatim from
// wip/nand_thread/scratch/{closer_a,closer_b,closer_c}; some of these do NOT
// individually match their targets (spaceCheck, writeBanner) -- that is
// irrelevant here, this file is never landed.
