...
// and NOT written into include/. Identical to the real header except for one
// added declaration (getGameDisplay(), needed by daPyMng_c::update(), called
// with a real `bl` per B3 -- mangled getGameDisplay__10dScStage_cFv). See
// BATCH3.md / ASSEMBLY.md.
...
public:
    ...
    /// @unofficial SHADOW-ONLY, not in the real header.
