...
// MATCH (101/101) -- see wip/wm_smallcloud/CREATEMODEL.md. The addi rX,rBASE,{0x88,0x98,0xa0}
// immediates the target used turned out to be dWmLib::sc_ForceList (include/game/bases/d_wm_lib.hpp,
// already odr-used by this TU for initState()'s IsCourseClear call) sitting immediately before this
// function's own resMdlNames table/sprintf format string/archive path string in .data -- not an
// aggregate this function declares itself.
