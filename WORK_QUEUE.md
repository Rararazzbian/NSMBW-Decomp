...
- Attempts: 6 (attempt 1: dtor closed; attempt 2: resume -- __dt MATCH,
  ...
  base dtor no landed TU can carry. Attempt 4: ten local-binding permutations
...
- Status: IN PROGRESS: container-worker-1 (claimed 2026-08-25, resumed same day as attempt 2)
- Attempts: 2
- Existing header: none
