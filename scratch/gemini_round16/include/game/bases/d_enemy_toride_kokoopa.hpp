...
public:
    ...
    virtual void getAtkEndTime();
    virtual void getAtkEndTime_Wait();
    virtual void getAtkSearchTime();
    virtual void getAtkSearch2ndTime();
    virtual void getDownTime();
    virtual void setAtkCnt();
    virtual void getJumpGravity();
    virtual float getDrawScale();
    virtual void speedUp();
    virtual void beginDance();
    virtual void getTurnSpeed();
    virtual void getFumiRecoverTime();
    virtual void createBlitz();
    virtual void createBlitz_sub() = 0;
    virtual void getMagicStickEffectOffset() const;
    virtual void setKokoopaCc();
    virtual void setShellCc();
    virtual void getJumpDist() const;
    ...
    virtual void getKokoopaOffFrm() const;
    virtual void getShellOnFrm() const;
    virtual void getKokoopaOnFrm() const;
    virtual void getShellOffFrm() const;
    virtual void checkGetUp() const;
    virtual void getCreateBlitzFrm() const;
    virtual void getShootFrm() const;
    virtual void getPressScale();
    virtual void getPressTime();
    virtual void defaultDirAngle();
    virtual void getShellChangeEffectOffsetY() const;
