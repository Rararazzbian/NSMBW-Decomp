...
def test_quake_variant(name, quake_body):
    ...
    for idx, (b, t) in enumerate(d_insns):
        if any(k in t for k in ['searchBaseByID', 'deleteRequest', 'UnKnownScoreSet', '0x770', 'cmpwi r3']):
            print(f'    {idx:2d}: {t}')
    print()

v14 = """    u8 dir = getPl_LRflag(mPos);
...
test_quake_variant("V14: (fBase_c*)mUnk770", v14)
