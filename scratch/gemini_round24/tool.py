...
DRAFT_SRC = 'scratch/gemini_round24/d_enemy_toride_kokoopa.cpp'
DRAFT_OBJ = 'scratch/gemini_round24/d_enemy_toride_kokoopa.o'
DRAFT_DIS = 'scratch/gemini_round24/draft_disasm.txt'
EXTRA_INC = ['scratch/gemini_round24/include']
