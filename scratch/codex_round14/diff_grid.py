...
# Target functions:
target_files = ['auto_00_00164204_text.txt', 'auto_fn_2_164380_text.txt']
target_fns = []
...
print(f"Loaded {len(target_fns)} target functions in d_a_wm_grid.cpp")

# Draft functions:
draft_fns = sibmap.parse(os.path.join(scratch_dir, 'd_a_wm_grid_compiled.txt'))
print(f"Loaded {len(draft_fns)} draft functions in d_a_wm_grid.cpp")

print("\n=== Per-Function Comparison for d_a_wm_grid.cpp ===")
