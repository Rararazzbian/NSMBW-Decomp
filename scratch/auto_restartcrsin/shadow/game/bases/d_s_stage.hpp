...
public:
    ...
    /// [.bss:0x803744BC] 15 byte entries picked by title-restart randomness.
    /// Read by dScRestartCrsin_c::startTitle. @unofficial
    static u8 m_titleRandomTable[15];

    /// [.sbss:0x8042A4D8] Index into m_titleRandomTable. @unofficial
