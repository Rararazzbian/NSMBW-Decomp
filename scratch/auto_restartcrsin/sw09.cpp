/* sw09: no named idx*2 -- subscripts carry idx*2 / idx*2+1 directly. */
...
void dScRestartCrsin_c::startTitle(unsigned char param1, bool param2) {
    ...
    if (param1 == 0) {
        ...
        int idx = dScStage_c::m_titleRandomTable[dScStage_c::m_titleCount];
        m_startGameInfo._0C = c_stage[idx * 2];
        m_startGameInfo._0D = c_stage[idx * 2 + 1];
