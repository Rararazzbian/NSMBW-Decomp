/* sw01: bind c_stage + idx to a pointer local before the two byte reads. */
...
void dScRestartCrsin_c::startTitle(unsigned char param1, bool param2) {
    ...
    if (param1 == 0) {
        ...
        const char *p = c_stage + dScStage_c::m_titleRandomTable[dScStage_c::m_titleCount] * 2;
        m_startGameInfo._0C = p[0];
        m_startGameInfo._0D = p[1];
