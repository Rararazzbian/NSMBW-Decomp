...
# Let's create mock headers in scratch/gemini_round4/mock_include
MOCK_DIR = os.path.join(ROOT, "scratch", "gemini_round4", "mock_include")
os.makedirs(os.path.join(MOCK_DIR, "lib", "egg", "core"), exist_ok=True)
os.makedirs(os.path.join(MOCK_DIR, "lib", "revolution", "OS"), exist_ok=True)
os.makedirs(os.path.join(MOCK_DIR, "lib", "revolution", "NAND"), exist_ok=True)
