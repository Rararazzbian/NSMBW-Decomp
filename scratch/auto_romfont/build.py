"""Build/diff driver for the dFunsuiAct_c unit (Linux container).
    ...
    python3 -c "import sys; sys.path.insert(0,'scratch/auto_romfont'); import build; \
...
BASE = os.path.join(ROOT, 'scratch', 'auto_romfont')
...
TARGET = os.path.join(ROOT, 'tools', 'auto_decomp', 'work',
                      'dol_bases_d_rom_font_manager', 'target.txt')
