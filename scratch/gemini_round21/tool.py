...
TARGET_FILES = [
    'scratch/gemini_round21/auto_03_800A8710_text.txt',
    'scratch/gemini_round21/auto_sinit_text.txt',
    'scratch/gemini_round21/auto_03_800B03D8_text.txt'
]
DRAFT_SRC = 'scratch/gemini_round21/d_enemy_toride_kokoopa.cpp'
DRAFT_OBJ = 'scratch/gemini_round21/d_enemy_toride_kokoopa.o'
DRAFT_DIS = 'scratch/gemini_round21/draft_disasm.txt'
EXTRA_INC = ['scratch/gemini_round21/include']
