...
dt_va = 0x800985B0
dt_sz = 0x80098670 - 0x800985B0
print(f"Destructor of dEnBoss_c @ {hex(dt_va)} (size {hex(dt_sz)}):")
for i in range(0, dt_sz, 4):
    word = dol_read_u32(dt_va + i)
    opcode = (word >> 26) & 0x3F
